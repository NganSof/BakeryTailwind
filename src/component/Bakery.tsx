  ...
  return (
    <div className="border-2 border-orange-600 rounded-xl w-60 h-[480px] mt-5 ml-10 overflow-hidden">
      <div className="flex flex-1 flex-col">
        ...
        <div id="baketyInfo">
          <p className="py-5 text-center">{bakery.description}</p>
        </div>
        <div id="bakeyPrice" className="flex justify-around items-center">
          <p className="font-mono font-extrabold tracking-wider text-xl italic">
            {/* ${bakery.price} */}
          </p>
          <button className="rounded-full shadow-xl shadow-zinc-500 p-1 hover:shadow-inset">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
